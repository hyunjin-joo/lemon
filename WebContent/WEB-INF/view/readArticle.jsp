...
<div class="table_under">
		...
		<a href="modify.do?no=${articleData.article.number}">수정</a>
		<a href="delete.do?no=${articleData.article.number}">삭제</a>
		</c:if>
...
<tr class="title1">
	...
	<td class="n1">제목</td>
	<td class="n2"><c:out value='${articleData.article.title}' /></td>
	
</tr>
<tr class="name1">
	
	<td class="n1">작성자</td>
	<td class="n2">${articleData.article.writer.name}</td>
	
</tr>
<tr class="date1">
	<td class="n1">작성일자</td>
	<td class="n2"><fmt:formatDate pattern="yyyy-MM-dd" value="${articleData.article.regDate}" /></td>
</tr>
<tr class="content1">
	<td class="n1">내용</td>
	<td class="bigbox"><u:pre value='${articleData.content}'/></td>
</tr>
</table>
</fieldset>
</div>
...
<a href="list.do?pageNo=${pageNo}" style="float:right; margin-top: 24px !important;font-size:13px;

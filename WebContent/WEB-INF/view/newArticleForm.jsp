...
<p style="margin-top:30px;">
	...
	style="width:250px; height:35px; margin-left:20px;">
	 <option value="" selected>분류를 선택하세요</option> 
	...
	<input type="text" name="title" value="${param.title}" placeholder=" 제목" style="width:650px; 
	height:29.6px; margin-left:15px;">
	<div class="error_m">
...
<p>
	...
	<textarea name="content"; style="width:920px; height:250px; margin-top:15px; 
	margin-left:20px;text-align:top">${param.title}</textarea>
</p>

<div class="s_head mt24">
<span><input type="submit" value="문의하기"></span>

<a href="list.do" style="float:right; margin-top: 24px !important;font-size:13px;
text-align:center;line-height:32px;margin-right:10px;
 background-color:#000040; width:90px; height:30px; color:lightyellow; cursor:pointer"
>목록</a>
</div>	
</form>
</fieldset>

					...
					<div id="util_menu">
						...
						<div class="top_right">
							<ul class="clfix">
								...
								<li class="last_child"><a href="#"><span>공지사항</span></a></li>
							</ul>
						</div>
					</div>
					<div class="line"></div>
...
<ul>
	...
	<li class="last_child"><a href="list2.do" class="link_tab">공지사항</a></li>
	<li><a href="#" class="link_tab">자주묻는질문</a></li>
	<li class="on">
	<a href="list.do" class="link_tab">문의내역</a></li>
...
<button type="button"><a href="#">작성하기</a></button>
</c:when>
<c:otherwise>
<button type="button"><a href="#">레몬공지</a></button>
</c:otherwise>
</c:choose>
 </u:isLogin> 
</div>	
...
<%-- <c:forEach var="article" items="${articlePage.content}"> --%>
	<tr>
		...
		<td>
		<a href="#" class="left">
		결제 서비스 업데이트 안내 (5/20 목, 03:00~05:00)
		</a>
		</td>
		<td>관리자</td>
		<td>
	...
	<tr>
		...
		<td>
		<a href="#" class="left">
		문화체육관광부 음원 사용료 징수규정 개정에 따른 가격 변경 및 판매종료 안내
		</a>
		</td>
		<td>관리자</td>
		<td>2021-05-19</td>
